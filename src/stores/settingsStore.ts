...
export interface FontSettings {
  fontFamily: 'amiri' | 'amiriQuran' | 'notoNaskh' | 'scheherazade' | 'uthman' | 'uthmanicHafs' | 'uthmanicHafs22' | 'hafsNastaleeq' | 'uthmanTN' | 'kfgqpcAnnotated' | 'meQuran' | 'qalam' | 'custom';
